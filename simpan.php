...
<head>
    ...
    <title>Form Pendaftaran Mhasiswa</title>
    <style type="text/css">
        <!--
        a:link {
        color: #36387B;
...
<body>
    ...
    <tr>
        ...
        <tr>
            <td height="45" align="center" bgcolor="Aqua"><h1>Form Nilai Mahasiswa</h1></td>
        </tr>
    <tr>
    ...
    <tr>
        <td> Nilai Tugas </td>
        <td> : </td>
        <td><input type='text' name='ntugas' size='10'/></td>
    </tr>
   
    <tr>
        <td>  Nilai UTS </td>
        <td> : </td>
        <td><input type='text' name='nuts' size='10'/></td>
    </tr>
    <tr>
        <td> Nilai UAS </td>
        <td> : </td>
        <td><input type='text' name='nuas' size='10'/></td>
    </tr>
